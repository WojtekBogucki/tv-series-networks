...
top_speakers = filter_by_speakers(friends_raw)
...
# top 30 speakers
top_speakers = filter_by_speakers(friends_raw, top=30)
...
save_seasons(friends_raw, path=path)
save_episodes(friends_raw, path=path)
