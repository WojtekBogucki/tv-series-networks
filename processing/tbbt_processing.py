import pandas as pd
from processing.processing import fix_names, split_characters, remove_speakers, distinguish_characters
import logging
...
def run_tbbt_processing():
    logger.info("Started TBBT processing...")
    ...
    logger.info("Finished TBBT processing.")
